...
<section class="explore-section section-padding" id="section_2">
    <div class="container">
        <div class="col-12 text-center">
            <h2 class="mb-4">Decouvrez vos endroits</h1>
        </div>
            ...
            <ul class="nav nav-tabs" id="myTab" role="tablist">
                ...
                <li class="nav-item" role="presentation">
                    <button class="nav-link active" id="design-tab" data-bs-toggle="tab"
                            data-bs-target="#{{ $category->title }}" type="button" role="tab" aria-controls="{{ $category->title }}"
                            aria-selected="true">{{ $category->title }}
                    </button>
                </li>
                @empty
        ...
        <div class="row">
            ...
            <div class="col-12">
                <div class="tab-content" id="myTabContent">
                    ...
                    <div class="tab-pane fade" id="{{ $category->title }}" role="tabpanel" aria-labelledby="{{ $category->title }}"
                         tabindex="0">
                        <div class="row">
